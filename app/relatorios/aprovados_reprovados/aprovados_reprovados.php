...
if ($situacao == '1')
	$sql .= " AND (m.nota_final >= $MEDIA_FINAL_APROVACAO and m.num_faltas < (d.carga_horaria/100)*25) ";

if ($situacao == '2')
	$sql .= " AND (m.nota_final < $MEDIA_FINAL_APROVACAO or m.num_faltas > (d.carga_horaria/100)*25) ";
