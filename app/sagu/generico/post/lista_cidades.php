...
function addcidade(){
   window.open("../cidades_inclui.php","popWindowCity","toolbar=no,width=600,height=368,top=5,left=5,directories=no,menubar=no,scrollbars=yes");
}
</script>
<?php
...
<form method="post" action="lista_cidades.php" name="selecao">
<div align="center">
