...
function MostraCampus()
{
	...
	while( $query->MoveNext() )
	{
		...
		$href  = "<a href=\"altera_campus.php?id=$registro\"><img src=\"../images/update.gif\" title='Alterar Cadastro' align='absmiddle' border=0></a>";
		$href1 = "";
...
{
  url = 'post/campus_exclui.php?id=' + arg1;
...
<form method="post" action="post/confirm_campus_inclui.php" name="myform">
