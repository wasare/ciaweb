...
<form method="post" action="post/instituicao_altera.php" name="myform">
  <div align="center">
    <table width="90%" align="center">
      <tr bgcolor="#000099"> 
        <td height="35" colspan="2">
          <div align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif"><b><font color="#CCCCFF">Altera&ccedil;&atilde;o de Institui&ccedil;&atilde;o</font></b></font></div>
        </td>
      </tr>
      <tr> 
      ...
      <tr> 
        <td bgcolor="#CCCCFF"><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#00009C">&nbsp;Nome da Institui&ccedil;&atilde;o&nbsp;<span class="required">*</span>&nbsp;</font></td>
        <td> 
          <input name="nome" type=text value="<?echo($nome);?>" size="40">
        </td>
      </tr>
      <tr> 
        <td bgcolor="#CCCCFF"><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#00009C">&nbsp;Sucinto&nbsp;</font></td>
        <td> 
          <input name="sucinto" type=text value="<?echo($sucinto);?>" size="40">
        </td>
      </tr>
      <tr> 
        <td bgcolor="#CCCCFF"><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#00009C">&nbsp;Nome Atual&nbsp;</font></td>
        <td> 
          <input name="nome_atual" type=text value="<?echo($nome_atual);?>" size="40">
        </td>
      </tr>
      <tr> 
        <td colspan="2"> 
