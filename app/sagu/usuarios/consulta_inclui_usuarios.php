...
function ListaPessoas()
{
	...
	if ( $like != "" )
	{
		...
		echo("    <td width=\"70%\"><b><font face=\"Verdana, Arial, Helvetica, sans-serif\" size=\"2\" color=\"$fg0\">Nome do Usuário</font></b></td>\n");
		...
		for ( $i=0; $i<25 && $query->MoveNext(); $i++ )
		{
			...
			$href  = "<a href=\"perfil_edita.php?nome=$nome\"><img src=\"../images/update.gif\" alt='Alterar Usuário' align='absmiddle' border=0></a>";
			$href1 = "<a href=\"javascript:Confirma_Exclui('$nome')\"><img src=\"../images/delete.gif\" alt='Excluir Usuário' align='absmiddle' border=0></a>";
...
function Confirma_Exclui(arg1)
{
  ...
  if (confirm("Você tem certeza que deseja EXCLUIR o usuário: "+arg1+" ?"))
    location=(url)
  else
...
<body bgcolor="#FFFFFF" marginwidth="20" marginheight="20"
	onload="_init()">
<form method="post" action="consulta_inclui_usuarios.php"
	name="selecao">
<div align="center">
<div class="titulo"><h2>Usu&aacute;rios do sistema</h2></div>
<p><input type="button" value=" Incluir Usuário "
	onClick="location='perfil_inclui.php'" name="button"></p>
<hr>
...
<table width="500" border="0" cellspacing="0" cellpadding="2"
	...
	<tr>
		<td colspan="4"><? ListaPessoas(); ?> <font
			...
			echo("<BR><center>Se o usuário não estiver listado, seja mais específico.</center>"); ?>
		</font></b></font></font></td>
	</tr>
	<tr align="center">
		<td colspan="4">
	...
	<tr align="center">
		...
		<ul>
			<li><font face="Arial, Helvetica, sans-serif" size="2"
				color="#0000CC"><b><font
				face="Verdana, Arial, Helvetica, sans-serif">Se o usuário que
			...
			de um usuário da lista pesquisada, clique na imagem correspondente.</font></b></li>
			<li><font face="Arial, Helvetica, sans-serif" size="2"
				color="#0000CC"><b><font
				face="Verdana, Arial, Helvetica, sans-serif">Se o usuário n&atilde;o
			estiver na lista acima, ele n&atilde;o est&aacute; cadastrado no
			sistema. Clique no bot&atilde;o &quot;Incluir Usuário&quot; para
