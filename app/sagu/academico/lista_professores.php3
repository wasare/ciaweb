...
function ListaProfessores()
{
   ...
   while( $query->MoveNext() )
   {
     ...
     $href  = "<a href=\"professores_edita.phtml?id=$id\">$ref_professor</a>";
...
<form method="post" action="">
  ...
  <div align="center"> 
    <input type="button" name="Button" value="  Voltar  " onClick="location='consulta_inclui_professores.phtml'">
  </div>
</form>
</body>
</html>
