...
function ListaPreRequisitos( $ref_curso=null )
{
	...
	echo ("<tr><td>&nbsp;</td></tr>");
	echo ("<tr>");
	echo ("<td bgcolor=\"#000099\" colspan=\"8\" height=\"28\" align=\"center\"><font size=\"3\" face=\"Verdana, Arial, Helvetica, sans-serif\" color=\"#FFFFFF\"><b>Listagem de Pré Requisitos Cadastrados</b></font></td>");
	echo ("</tr>");
	...
	while( $query->MoveNext() )
	{
		...
		if ($aux_curso != $ref_curso)
		{
			...
			echo ("<td width=\"28%\"><Font face=\"Verdana\" size=\"2\" color=\"#ffffff\"><b>Cód - Disciplina Pré</b></font></td>");
		...
		$href  = "<a href=\"edita_pre_requisito.php?id=$id\"><img src=\"../images/update.gif\" alt='Alterar Pré-Requisito' align='absmiddle' border=0></a>";
...
{
    url = 'post/pre_requisito_exclui.php?id=' + arg1;

  if (confirm("Você tem certeza que deseja EXCLUIR o Pré-requisito?"))
    location=(url)
  else
...
<div align="center"><input type="button" name="Button"
	value="  Voltar  "
	onClick="location='consulta_inclui_pre_requisito.php'"></div>
</form>
</body>
</html>
