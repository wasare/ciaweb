...
function Lista_Cursos()
{
	...
	if ( $like != "" )
	{
		...
		for ( $i=0; $i<25 && $query->MoveNext(); $i++ )
		{
			...
			$href  = "<a href=\"curso_altera.php?id=$id\"><img src=\"../images/update.gif\" title='Alterar' align='absmiddle' border=0></a>";
...
{
  url = 'post/cursos_exclui.php?id=' + arg1;

  if (confirm("Você tem certeza que deseja excluir o Curso: "+arg1))
    location=(url)
  else
...
<body bgcolor="#FFFFFF" marginwidth="20" marginheight="20"
	onload="_init()">
<form method="post" action="consulta_cursos.php" name="myform">
<div align="center">
<div class="titulo" align="center"><h2>Cursos</h2></div>
<p><input type="button" value=" Incluir "
	onClick="location='curso_ins.php'" name="button"> <input
	type="button" value=" Listar " onClick="location='lista_cursos.php'"
	name="button1"></p>
</div>
<hr align="center" width="500">
<p align="center"><font face="Verdana, Arial, Helvetica, sans-serif"
	size="2" color="#0000FF"><b><font color="#FF0000">CUIDADO PARA NÃO
...
<table width="500" border="0" cellspacing="0" cellpadding="2"
	...
	<tr>
		<td colspan="4"><?php Lista_Cursos(); ?> <font
			face="Verdana, Arial, Helvetica, sans-serif"><font size="2"><b><font
			color="#FF0000"> </font><font
			face="Verdana, Arial, Helvetica, sans-serif"><font size="2"><b><font
			color="#FF0000"><?PHP  if ( $hasmore )
			echo("<BR>Se o Curso não estiver listado, seja mais específico."); ?></font></b></font></font><font
