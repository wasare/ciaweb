...
function ListaPeriodos()
{
	...
	if ( $like != "" )
	{
		...
		for ( $i=0; $i<25 && $query->MoveNext(); $i++ )
		{
			...
			$href  = "<a href=\"periodos_altera.php?id=$id\"><img src=\"../images/update.gif\" title='Alterar Cadastro' align='absmiddle' border=0></a>";
			$href1 = "<a href=\"javascript:Confirma_Exclui('$registro')\"><img src=\"../images/delete.gif\" title='Excluir Período' align='absmiddle' border=0></a>";
...
{
  url = 'post/periodos_exclui.php?id=' + arg1;

  if (confirm("Você tem certeza que deseja EXCLUIR o Período: "+arg1+" ?"))
    location=(url)
  else
...
<body bgcolor="#FFFFFF" marginwidth="20" marginheight="20"
	onload="_init()">
<form method="post" action="consulta_periodos.php" name="myform">
<div align="center">
<div class="titulo"><h2>Per&iacute;odos letivos</h2></div>
<p><input type="button" value="  Incluir  "
	onClick="location='periodos.php'" name="button"></p>
</div>
...
<table width="500" border="0" cellspacing="0" cellpadding="2"
	...
	<tr bgcolor="#0066CC">
		...
		de Per&iacute;odos letivos</font></b></font></div>
		</td>
	</tr>
	<tr>
		<td width="6">&nbsp;</td>
	...
	<tr>
		<td colspan="4"><?PHP ListaPeriodos(); ?> <font
			face="Verdana, Arial, Helvetica, sans-serif"><font size="2"><b><font
			color="#FF0000"> </font><font
			face="Verdana, Arial, Helvetica, sans-serif"><font size="2"><b><font
			color="#FF0000"><?PHP  if ( $hasmore )
			echo("<BR><center>Se o Período não estiver listado, seja mais específico.</center>"); ?></font></b></font></font><font
