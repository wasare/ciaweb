...
<html>
    <head>
        ...
        <script language="JavaScript">
            ...
            {
                url = 'consulta_inclui_pessoa.php' +
            ...
            {
                url = 'post/pessoaf_exclui.php?id=' + arg1;

                if (confirm("Você tem certeza que deseja EXCLUIR o Pessoa: "+arg1))
                    location=(url)
                else
...
function ListaPessoas()
{
    ...
    if ( $like != "" )
    {
        ...
        if ( $desc != '' )
        {
            ...
            $where .= " SIMILAR TO lower(to_ascii('". $_POST['desc']."%','LATIN1')) ";
        ...
        for ( $i=0; $i<25 && $query->MoveNext(); $i++ )
        {
            ...
            $href3  = "<a href=\"documentos_edita.php?id=$id\"><img src=\"../images/hist.gif\" title='Documentos' align='absmiddle' border=0></a>";
            $href  = "<a href=\"pessoaf_edita.php?id=$id\"><img src=\"../images/update.gif\" title='Alterar Cadastro' align='absmiddle' border=0></a>";
...
<link href="../estilo.css" rel="stylesheet" type="text/css" />
    ...
    <body bgcolor="#FFFFFF" marginwidth="20" marginheight="20" onload="_init()">
        ...
        <form method="post" action="consulta_inclui_pessoa.php" name="selecao">
            <div align="center">
            
                <div class="titulo"><h2>Pessoas F&iacute;sicas</h2></div>
            
                <p>
                    <input type="button" value="   Incluir   " onClick="location='pessoaf_inclui.php'" name="incluir">         
                </p>
                <hr width="500">
