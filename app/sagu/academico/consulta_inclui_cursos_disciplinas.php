		...
		for ($aux=0; $aux<2; $aux++)
		{
			...
			for ( $i=0; $query->MoveNext(); $i++ )
			{
				...
				if ($i == 0)
				{
					...
					echo("    <td width=\"5%\" align=\"center\"><b><font face=\"Verdana, Arial, Helvetica, sans-serif\" size=\"2\" color=\"$fg0\">Créd</font></b></td>\n");
				...
				$href  = "<a href=\"cursos_disciplinas_edita.php?ref_curso=$ref_curso&ref_disciplina=$id_disciplina&ref_campus=$id_campus\"><img src=\"../images/update.gif\" title='Alterar' align='absmiddle' border=0></a>";
			...
			if ($tot_disciplinas > 0)
			{
				...
				echo(" <tr bgcolor=\"$bg0\">\n");
				echo("  <td  colspan=\"3\"><b><font face=\"Verdana, Arial, Helvetica, sans-serif\" size=\"2\" color=\"$fg0\">Totais: Créditos: $tot_num_creditos</font></b></td>\n");
				echo("  <td  colspan=\"3\"><b><font face=\"Verdana, Arial, Helvetica, sans-serif\" size=\"2\" color=\"$fg0\">Disciplinas: $tot_disciplinas</font></b></td>\n");
				echo("  <td  colspan=\"3\" align=\"right\"><b><font face=\"Verdana, Arial, Helvetica, sans-serif\" size=\"2\" color=\"$fg0\">Carga Horária: $tot_carga_horaria</font></b></td>\n");
				echo(" </tr>\n");
...
{
    url = 'post/cursos_disciplinas_exclui.php?ref_curso=' + arg1 + '&ref_disciplina=' + arg2 + '&ref_campus=' + arg3;

  if (confirm("Você tem certeza que deseja EXCLUIR a Disciplina "+arg2+" do Curso "+arg1+" no Campus "+arg3))
    location=(url)
  else
...
<body bgcolor="#FFFFFF" marginwidth="20" marginheight="20"
	onload="_init()">
<form method="post" action="consulta_inclui_cursos_disciplinas.php"
	name="selecao">
<div align="center">
<div class="titulo" align="center"><h2>Cursos/Disciplinas (Matriz curricular)</h2></div>
<p><input type="button" value=" Incluir "
	onClick="location='cursos_disciplinas.php'" name="button"></p>
