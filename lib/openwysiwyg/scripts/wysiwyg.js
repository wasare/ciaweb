...
var WYSIWYG = {
	...
	_generate: function(n, settings) {
		...
		for (var j = 0; j < this.config[n].Toolbar.length;j++) { 
			if(this.config[n].Toolbar[j] && this.config[n].Toolbar[j].length > 0) {
	    		...
	    		editor += '<tr><td style="width:6px;"><img src="../../../../avisos/openwysiwyg_v1.4.7/scripts/' + this.config[n].ImagesDir + 'seperator2.gif" alt="" hspace="3"></td>';
	...
	writeDropDown: function(n, id) {
		...
		output += '<img src="../../../../avisos/openwysiwyg_v1.4.7/scripts/' + image + '" id="img_' + dropdown.id + '_' + n + '" height="20" onClick="WYSIWYG.openDropDown(\'' + n + '\',\'' + dropdown.id + '\');" unselectable="on" border="0"><br>';
...
var WYSIWYG_ContextMenu = {
	...
	addItem: function(n, cmd, icon, title, disabled) {
		...
		if(disabled) {
			item += '<tr>';
			item += '<td class="icon"><a href="javascript:WYSIWYG.execCommand(\'' + n + '\',\'' + cmd + '\', null);"><img src="../../../../avisos/openwysiwyg_v1.4.7/scripts/' + icon.enabled + '" border="0"></a></td>';
			...
			item += '<tr>';
			item += '<td class="icon"><img src="../../../../avisos/openwysiwyg_v1.4.7/scripts/' + icon.disabled + '" border="0"></td>';
