 ...
 ********************************************************************/
require('../../../../../avisos/openwysiwyg_v1.4.7/addons/imagelibrary/config.inc.php');
error_reporting(0);
		...
		<tr>
			<td>
				  <?php
					...
					if($dirok) {
					?>
					<a href="<?php echo $_SERVER['../../../../../avisos/openwysiwyg_v1.4.7/addons/imagelibrary/PHP_SELF'].'?dir='.urlencode($dotdotdir); ?>"><img src="../../../../../avisos/openwysiwyg_v1.4.7/addons/imagelibrary/images/dirup.png" alt="Folder" border="0" /> <strong>..</strong></a><br>
					<?php
						if($class=='b') $class='w';
						else $class = 'b';
					}
					...
					?>
					<a href="<?php echo $_SERVER['../../../../../avisos/openwysiwyg_v1.4.7/addons/imagelibrary/PHP_SELF'].'?dir='.urlencode($leadon.$dirs[$i]); ?>"><img src="../../../../../avisos/openwysiwyg_v1.4.7/addons/imagelibrary/images/folder.png" alt="<?php echo $dir; ?>" border="0" /> <strong><?php echo $dir; ?></strong></a><br>
					<?php
						if($class=='b') $class='w';
						else $class = 'b';	
					}
