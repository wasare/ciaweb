// Tigra Calendar v4.0.2 Brasileiro (dd/mm/yyyy)
...
var A_TCALDEF = {
	...
	'imgpath' : caminho_img_tigra // directory with calendar images var caminho_img_tigra = '../../lib/tigra_calendar/img/';
}
...
function tcal (a_cfg, a_tpl) {
	...
	if (!this.e_icon) {
		document.write('<img src="' + a_tpl.imgpath + 'cal.gif" id="' + this.s_iconId + '" onclick="A_TCALS[\'' + this.s_id + '\'].f_toggle()" class="tcalIcon" alt="Abrir Calendário" />');
		this.e_icon = f_getElement(this.s_iconId);
	}
...
function f_tcalShow (d_date) {
	...
	this.e_icon.title = 'Fechar calendario';
	this.b_visible = true;
}
